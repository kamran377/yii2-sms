...
use yii\web\View;
use kamran377\sms\SmsInterface;
...
abstract class BaseSms extends Component implements SmsInterface, ViewContextInterface
{
     ...
     * by [[MessageInterface]] can be configured, such as `from`, etc.
     *
     * For example:
     *
     * ```php
     ...
     */
    public $messageClass = 'kamran377\sms\BaseMessage';
     ...
     *
     * - a string, which represents the view name or [path alias](guide:concept-aliases) for rendering the text body of the message.
    ...
    protected function saveMessage($message)
    {
        ...
        $contents = 'From: ' . $message->getFrom() . PHP_EOL .
                    'To: ' . $message->getTo() . PHP_EOL .
                    'Message: ' . PHP_EOL .
                    $message->toString();
    ...
    public function generateMessageFileName()
    {
        ...
        return date('m-d-Y_h:i:s_a_', $time) . sprintf('%04d', (int) (($time - (int) $time) * 10000)) . '-' . sprintf('%04d', mt_rand(0, 10000)) . '.txt';
    }
